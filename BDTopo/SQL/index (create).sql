...
create index if not exists bdtopo_departement_code_geometrie on bdtopo_departement using gist (geometrie);

create index if not exists bdtopo_troncon_de_route_cleabs on bdtopo_troncon_de_route (cleabs);
